...
class GEstadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create g_estado" do
    assert_difference("GEstado.count") do
      post g_estados_url, params: { g_estado: { descricao: @g_estado.descricao, g_pais_id: @g_estado.g_pais_id } }
    end
  ...
  test "should update g_estado" do
    patch g_estado_url(@g_estado), params: { g_estado: { descricao: @g_estado.descricao, g_pais_id: @g_estado.g_pais_id } }
